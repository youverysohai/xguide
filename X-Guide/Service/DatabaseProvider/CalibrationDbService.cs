...
{
    internal class CalibrationDbService : DbServiceBase, ICalibrationService
    {

        public CalibrationDbService(DbContextFactory dbContextFactory, IMapper mapper) : base(dbContextFactory, mapper)
        {
